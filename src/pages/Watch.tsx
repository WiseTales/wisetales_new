...
const Watch = () => {
  ...
  const stories = [
    ...
    },
    {
      ...
      title: 'Zayn Ki Seekh',
      description:
        "Zayn's journey of cleanliness, manners, and responsibility told through heartwarming animation.",
      value: 'cleanliness',
      duration: '4:13',
      views: '—',
    ...
    },
    {
      ...
      description:
        'A beautiful 3D story about respecting elders, neighbors, and community.',
      value: 'respect',
      duration: '1:39',
      views: '—',
    ...
    },
    {
      ...
      description:
        'Two brothers learn the value of sharing through a sweet and surprising mango story.',
      value: 'sharing',
      duration: '1:51',
      views: '—',
    ...
    },
    {
      ...
      description:
        'An animated tale teaching the power of sincerity in our actions.',
      value: 'sincerity',
      duration: '1:46',
      views: '—',
    ...
    },
    {
      ...
      title: 'Honest Hearts',
      description:
        'A moral story about the importance of honesty, trust, and doing the right thing.',
      value: 'honesty',
      duration: '1:36',
      views: '—',
    ...
    },
    {
      ...
      description:
        'Watch this inspiring moral story about respect, kindness, and believing in others',
      value: 'respect',
      duration: '1:34',
      views: '—',
      thumbnail: 'quiet-boy',
    ...
    },
    {
      ...
      description:
        'Milo was proud of being the fastest banana picker in the jungle. But when he rushed to gather bananas for the picnic, he learned a big lesson—speed isn’t always success!',
      value: 'patience',
      duration: '2:15',
      views: '—',
    ...
    },
    {
      ...
      description:
        'Meet Lulu, a cheerful bunny who suddenly loses her smile! With the help of her friends Toto the Turtle, Mimi the Bird, and her loving Grandma Bunny, she learns that happiness doesn’t come from outside—it comes from kindness, love, and sharing.',
      value: 'kindness',
      duration: '2:43',
      views: '—',
    ...
    },
    {
      ...
      title: 'A Little Drop',
      description:
        '“A Little Drop” is a heart-touching short story that reminds us: no act of goodness is ever too small.',
      value: 'hope',
      duration: '2:24',
      views: '—',
    ...
    },
    {
      ...
      description:
        '“The Magic Feather” is a touching and inspiring short story about self-belief, courage, and discovering the magic within.',
      value: 'courage',
      duration: '3:29',
      views: '—',
    ...
    },
    {
      ...
      description:
        'This 160-second flood awareness short film shows how disasters unfold and how simple safety steps save lives.',
      value: 'short-films',
      duration: '3:27',
      views: '—',
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredStories.map((story) => {
            ...
            return (
              <Card
                key={story.id}
                className="border-sage-200 bg-white/80 backdrop-blur-sm hover:shadow-xl transition-all duration-300 group"
              >
